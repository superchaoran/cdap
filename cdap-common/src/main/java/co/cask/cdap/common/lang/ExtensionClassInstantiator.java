...
/**
 * Class used to load and instantiate class from external jar
 */
public final class ExtensionClassInstantiator {

  private ExtensionClassInstantiator(){
   ...
   * @param tmpDir
   * @param interfaceNameInExceptionMessages
